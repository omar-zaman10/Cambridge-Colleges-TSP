...
if __name__ == "__main__":
    ...
    map3 = folium.Map(location=[52.2069577, 0.1130816], zoom_start=13.5)
    map4 = folium.Map(location=[52.2069577, 0.1130816], zoom_start=13.5)
    ...
    for college in geocodes:
        ...
        map1.add_child(
            folium.Marker(
                location=[lat, lng], popup=college, icon=folium.Icon(color="red")
            )
        )
        map2.add_child(
            folium.Marker(
                location=[lat, lng], popup=college, icon=folium.Icon(color="green")
            )
        )
