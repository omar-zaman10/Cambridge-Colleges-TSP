...
from config import colleges, key

if __name__ == "__main__":
    if key == "YOUR_GOOGLE_MAPS_API_KEY_HERE":
        raise ValueError("API key is not entered in .env file")
    ...
    for college in colleges:
        ...
        distance1 = gmaps.distance_matrix(
            [[g1[0], g1[1]]], geo_list[:15], mode="bicycling"
        )
        distance2 = gmaps.distance_matrix(
            [[g1[0], g1[1]]], geo_list[15:], mode="bicycling"
        )
